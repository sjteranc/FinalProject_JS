...
public class AgileGridApplication {
  ...
  static void addList(Scanner scanner, Board board) {
  ...
  static void addCardToList(Scanner scanner, Board board) {
    System.out.print("Enter list name: ");
  ...
  static void searchList(Scanner scanner, Board board) {
  ...
  static void searchCardById(Scanner scanner, Board board) {
    ...
    while (listContainingCard != null) {
      Card foundCard = listContainingCard.findCard(cardIdToSearch);
      if (foundCard != null) {
  ...
  // Delete a card by ID
  static void deleteCardById(Scanner scanner, Board board) {
  ...
  // Update a card by ID
  static void updateCardById(Scanner scanner, Board board) {
  ...
  static void deleteListByName(Scanner scanner, Board board) {
  ...
  static void updateListByName(Scanner scanner, Board board) {
